...
object MessageModels2 {
  ...
  object Update {
    ...
    //@ConfiguredJsonCodec sealed trait ActionsUpdate
    @ConfiguredJsonCodec final case class ButtonUpdate(actionId: String) // extends ActionsUpdate
    //@ConfiguredJsonCodec final case class ConversationsSelect(selectedConversation: String) extends ActionsUpdate
  }
